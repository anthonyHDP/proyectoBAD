<template><!--Aquí colocamos la parte de HTML -->
   <main class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <label class="titulo-encabezados">Ejemplo "Matrimonios"</label>
                    </div>
                    <div class="card-body">
...
<script>//Aquí colocamos la parte de JS
    export default {
      data(){
          //En esta función declaramos las variables que utilizaremos
            return{
